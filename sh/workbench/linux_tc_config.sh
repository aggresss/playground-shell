...
tc class add dev ${INF_NAME} parent 1:1 classid 1:20 htb rate 10mbit
tc qdisc add dev ${INF_NAME} parent 1:20 handle 20: netem delay 500ms loss 30%
tc filter add dev ${INF_NAME} protocol ip parent 1: prio 3 u32 match ip dst 192.168.200.101 flowid 1:20
