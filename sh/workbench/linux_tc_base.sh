...
tc class add dev ${INTERFACE_NAME} parent 1:1 classid 1:10 htb rate 10mbit
tc qdisc add dev ${INTERFACE_NAME} parent 1:10 handle 10: sfq perturb 10
tc filter add dev ${INTERFACE_NAME} protocol ip parent 1: prio 1 u32 match ip sport 22 0xffff flowid 1:10
